...
public class BowlTerrain {

	private static final float SIZE = 3200;
	...
	public BowlTerrain(int gridX, int gridZ, Loader loader, TerrainTexturePack texturePack, TerrainTexture blendMap, String heightMap){
